...
{
    public class MassNumberOfMinesTest : BaseControlDemo
    {
        #region newer stuff
        public MassNumberOfMinesTest()
            : base()
        {
        ...
        {
            OldDirectXTests.MassNumberOfMinesTest(world);
        ...
        public override string Name
        {
            get
            {
                return "Mass Number Of Mines Test";
            }
        }
        public override string Description
        {
            get
            {
                return "A large number of objects that explode on contact.";
            }
        }
        public override IDemo CreateNew()
        {
            return new MassNumberOfMinesTest();
        }
        #endregion
    }
}
