...
{
    public class MassNumberTestWithRestPlace : BaseControlDemo
    {
        #region newer stuff
        public MassNumberTestWithRestPlace()
            : base()
        {
        ...
        {
            OldDirectXTests.MassNumberTestWithRestPlace(world);
        ...
        public override string Name
        {
            get
            {
                return "Mass Number Test With Rest Place";
            }
        }
        public override string Description
        {
            get
            {
                return "A large number of object ready to fall on a planetoid.";
            }
        }
        public override IDemo CreateNew()
        {
            return new MassNumberTestWithRestPlace();
        }
        #endregion
    }
}
