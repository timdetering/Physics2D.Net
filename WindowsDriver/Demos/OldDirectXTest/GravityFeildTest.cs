...
{
    public class GravityFieldTest : BaseControlDemo
    {
        #region newer stuff
        public GravityFieldTest()
            : base()
        {
        ...
        {
            OldDirectXTests.GravityFieldTest(world);
        ...
        public override string Description
        {
            get
            {
                return "A test showing a large number of object falling onto a large number of immovible platforms";
            }
        }
        public override IDemo CreateNew()
        {
            return new GravityFieldTest();
        }
        #endregion
    }
}
